...
@SpringBootTest(classes = CqrsEventSubscriberInMemoryTest.Config.class, webEnvironment = SpringBootTest.WebEnvironment.RANDOM_PORT)
public class CqrsEventSubscriberInMemoryTest {

    @Configuration
    @EnableAutoConfiguration
    @Import({
            EventPublisherConfiguration.class, CqrsEventSubscriberConfiguration.class,
